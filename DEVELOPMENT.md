...
```bash
git remote add encore encore://solana-meme-coin-creator-4ku2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/solana-meme-coin-creator-4ku2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/solana-meme-coin-creator-4ku2/settings/integrations/github)
